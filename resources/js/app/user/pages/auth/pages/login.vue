    ...
    <div class="d-flex justify-content-center align-items-center">
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            ...
            <form @submit.prevent="login()" class="w-100 p-5 shadow bg-white">
                ...
                <div class="mb-3">
                    <!-- Action button -->
                    <button type="submit" class="btn btn-theme width-100" v-if="!loading">
                        Login
                    </button>
                    <button type="button" class="btn btn-theme width-100 btn-loading d-flex justify-content-center align-items-center" v-if="loading">
